...
public class Client extends JFrame implements KeyListener {
	...
	public Client() {
		...
		panel.setBorder(new TitledBorder(null, "\u6E38\u620F\u4FE1\u606F",
	...
	public void keyPressed(KeyEvent e) {
		try {
			...
			case KeyEvent.VK_W:
				...
				orientation = "up";
				//想服务端发送数据包
				udpClient.send("192.168.1.101", 9999, "lisi", tankloc.x+"", tankloc.y+"", "up", 0);
				break;
			case KeyEvent.VK_A:
				...
				orientation = "left";
				udpClient.send("192.168.1.101", 9999, "lisi", tankloc.x+"", tankloc.y+"", "left", 0);
				break;
			case KeyEvent.VK_S:
				...
				tankloc.translate(0, tankspeed);
				orientation = "down";
				udpClient.send("192.168.1.101", 9999, "lisi", tankloc.x+"", tankloc.y+"", "down", 0);
				break;
			case KeyEvent.VK_D:
				...
				tankloc.translate(tankspeed, 0);
				orientation = "right";
				udpClient.send("192.168.1.101", 9999, "lisi", tankloc.x+"", tankloc.y+"", "right", 0);
				break;
			default:
				break;
			}
	...
	public void keyReleased(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_J) {
			switch (orientation) {
			case "up":
				Bullet bullet_1 = new Bullet(tankloc.x + 8, tankloc.y - 32,
						"up");
				...
				break;
			case "down":
				Bullet bullet_2 = new Bullet(tankloc.x + 8, tankloc.y + 20,
						"down");
				...
				break;
			case "left":
				Bullet bullet_3 = new Bullet(tankloc.x - 15, tankloc.y - 3,
						"left");
				...
				break;
			case "right":
				Bullet bullet_4 = new Bullet(tankloc.x + 35, tankloc.y - 6,
						"right");
